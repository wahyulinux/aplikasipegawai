...
<div class="no-print mb-6 flex justify-between items-center">
    <div>
        <h1 class="text-2xl font-bold text-gray-800">Laporan Rekapitulasi Lembur</h1>
...
<div class="bg-white p-10 rounded-xl shadow-xl border border-gray-200" id="report-container">
    <div class="text-center mb-8 border-b-2 border-indigo-600 pb-4">
        <h1 class="text-3xl font-extrabold text-indigo-800 uppercase">Rekapitulasi Pendapatan Lembur</h1>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full border-collapse border border-gray-300">
            ...
            <tbody class="text-sm text-gray-700">
                ...
                @empty
                <tr>
                    <td colspan="6" class="py-10 text-center text-gray-400 italic">Tidak ada data Lembur pada periode ini.</td>
                </tr>
                @endforelse
            </tbody>
    ...
    @include('partials.signature_staff', ['jenis' => 'Rekapitulasi Lembur'])
</div>
