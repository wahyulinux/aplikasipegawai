...
<div class="no-print mb-6 flex justify-between items-center">
    <div>
        <h1 class="text-2xl font-bold text-gray-800">Laporan Detail Lembur</h1>
    ...
    <div class="space-x-4">
        ...
        <a href="{{ route('overtime.index') }}" class="bg-gray-500 text-white px-6 py-2 rounded-lg hover:bg-gray-600 font-bold shadow-md transition duration-300">Kembali</a>
    </div>
</div>
...
<div class="bg-white p-10 rounded-xl shadow-xl border border-gray-200" id="report-container">
    <div class="text-center mb-8 border-b-2 border-indigo-600 pb-4">
        <h1 class="text-3xl font-extrabold text-indigo-800 uppercase">Log Aktivitas Harian Lembur</h1>
        ...
        <table class="min-w-full border-collapse border border-gray-300">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="border border-gray-300 py-3 px-4 text-left uppercase text-xs font-bold">Daftar Pegawai Lembur</th>
            ...
            <tbody class="text-sm text-gray-700">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="border border-gray-300 py-3 px-4 text-center font-bold">{{ $ot->tanggal->format('d/m/Y') }}</td>
                    ...
                    <td class="border border-gray-300 py-3 px-4 text-right font-bold text-green-700">Rp {{ number_format($ot->nominal_per_orang * $ot->employees->count(), 0, ',', '.') }}</td>
                    <td class="border border-gray-300 py-3 px-4 italic text-xs">{{ $ot->keterangan ?: '-' }}</td>
                </tr>
                @empty
                <tr>
                    <td colspan="5" class="py-10 text-center text-gray-400 italic">Tidak ada data Lembur pada periode ini.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    @include('partials.signature_staff', ['jenis' => 'Detail Lembur'])
</div>
