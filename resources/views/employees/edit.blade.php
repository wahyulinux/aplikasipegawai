...
<div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow">
    ...
    <form action="{{ route('employees.update', $employee->id) }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="telegram_chat_id" value="{{ old('telegram_chat_id', $employee->telegram_chat_id) }}" placeholder="Contoh: 123456789" class="w-full px-3 py-2 border rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
