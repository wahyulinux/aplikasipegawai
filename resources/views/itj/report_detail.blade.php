...
<div class="no-print mb-6 flex justify-between items-center">
    <div>
        <h1 class="text-2xl font-bold text-gray-800">Laporan Detail Work Order ITJ</h1>
...
<div class="bg-white p-10 rounded-xl shadow-xl border border-gray-200" id="report-container">
    <div class="text-center mb-8 border-b-2 border-green-600 pb-4">
        <h1 class="text-3xl font-extrabold text-green-800 uppercase">Log Aktivitas Detail Work Order ITJ</h1>
        ...
        <table class="min-w-full border-collapse border border-gray-300">
            ...
            <tbody class="text-sm text-gray-700">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="border border-gray-300 py-3 px-4 font-bold text-green-700">{{ $wo->kode_wo }}</td>
            ...
            <tfoot class="bg-gray-50">
                <tr>
                    ...
                    <th class="border border-gray-300 py-3 px-4 text-right font-black text-green-800 text-sm">Rp {{ number_format($workOrders->sum('nominal_total'), 0, ',', '.') }}</th>
    ...
    @include('partials.signature_staff', ['jenis' => 'Detail Work Order ITJ'])
</div>
