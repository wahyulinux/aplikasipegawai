...
<div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 space-y-4 md:space-y-0">
    ...
    <div class="flex flex-col sm:flex-row w-full md:w-auto space-y-2 sm:space-y-0 sm:space-x-2">
        <form action="{{ route('itj.report') }}" method="GET" class="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-2 w-full sm:w-auto">
            ...
            <div class="flex space-x-2 w-full sm:w-auto">
                ...
                <button type="submit" formaction="{{ route('itj.report_detail') }}" class="w-full sm:w-auto bg-teal-600 text-white px-4 py-2 rounded hover:bg-teal-700 text-sm font-bold whitespace-nowrap">Cetak Detail WO</button>
            </div>
        </form>
