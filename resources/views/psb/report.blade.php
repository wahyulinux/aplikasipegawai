...
<div class="no-print mb-6 flex justify-between items-center">
    <div>
        <h1 class="text-2xl font-bold text-gray-800">Laporan Bulanan PSB</h1>
...
<div class="bg-white p-10 rounded-xl shadow-xl border border-gray-200" id="report-container">
    <div class="text-center mb-8 border-b-2 border-blue-600 pb-4">
        <h1 class="text-3xl font-extrabold text-blue-800 uppercase">Rekapitulasi Pendapatan PSB</h1>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full border-collapse border border-gray-300">
            ...
            <tbody class="text-sm text-gray-700">
                ...
                @empty
                <tr>
                    <td colspan="5" class="py-10 text-center text-gray-400 italic">Tidak ada data PSB pada periode ini.</td>
                </tr>
                @endforelse
            </tbody>
    ...
    @include('partials.signature_staff', ['jenis' => 'Rekapitulasi PSB'])
</div>
