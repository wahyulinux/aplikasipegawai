...
<div class="max-w-md mx-auto bg-white p-10 rounded-2xl shadow-2xl border border-gray-100">
    ...
    <form action="{{ route('users.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="telegram_chat_id" placeholder="Contoh: 123456789" class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none">
