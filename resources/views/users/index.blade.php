    ...
    <div class="overflow-x-auto">
        <table class="min-w-full">
            <thead class="bg-gray-50 text-gray-600 uppercase text-xs font-bold tracking-wider">
                <tr>
                    <th class="py-4 px-6 text-left whitespace-nowrap">Nama Lengkap</th>
                    <th class="py-4 px-6 text-left whitespace-nowrap">Email</th>
                    <th class="py-4 px-6 text-center whitespace-nowrap">Role</th>
            ...
            <tbody class="text-gray-600 text-sm">
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                    <td class="py-4 px-6 font-bold text-gray-800 whitespace-nowrap">{{ $user->name }}</td>
