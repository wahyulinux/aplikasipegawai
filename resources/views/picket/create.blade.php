...
<div class="max-w-2xl mx-auto bg-white p-10 rounded-2xl shadow-2xl border border-gray-100 mt-10">
    <div class="mb-8 border-b pb-4">
        <h1 class="text-3xl font-extrabold text-gray-900">Input Data Piket (Standby)</h1>
        <p class="text-sm text-gray-500 mt-2">Tarif Piket per Orang: <span class="font-bold text-green-600">Rp {{ number_format($defaultNominal, 0, ',', '.') }}</span></p>
    </div>
    
    <form action="{{ route('picket.store') }}" method="POST" class="space-y-6">
        @csrf
        <div>
            <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">Tanggal Piket</label>
        ...
        <div>
            <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">Pilih Pegawai Piket</label>
        ...
        <div>
            ...
            <textarea name="keterangan" rows="2" placeholder="Tugas piket yang dikerjakan..."
        ...
        <div class="pt-6 flex items-center justify-between">
            <a href="{{ route('picket.index') }}" class="text-gray-500 hover:text-gray-800 font-bold transition">Batal</a>
